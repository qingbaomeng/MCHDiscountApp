...
-(void) initStarConfig:(StarStyleType)styleType{
    [self initStarConfig:styleType numberOfStars:0];
}

-(void) setStarNumber:(CGFloat)numberOfStars{
    [self initStarConfig:mStyleType numberOfStars:numberOfStars];
}

-(void) initStarConfig:(StarStyleType)styleType numberOfStars:(CGFloat)numberOfStars{
...
//    NSLog(@"#setScorePercent--cur:%ld, total:%ld", (long)numberOfStars, (long)self.numberOfStars);
    self.scorePercent = numberOfStars / self.numberOfStars;
}
...
//    self.scorePercent = starScore / self.numberOfStars;
    ...
    CGFloat selectStar = gesture.view.tag + 1;
    self.scorePercent = selectStar / self.numberOfStars;
    [_delegate currentSelectStarIndex:selectStar];
}
...
//    NSLog(@"#setScorePercent--%f", scroePercent);
